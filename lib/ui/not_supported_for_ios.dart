    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              Container(
                child: Text('Not Supported For iOS', style: TextStyle(
              ...
              Container(
                ...
                child: Container(
                  child: Text('This package or plugin are not supported for iOS when the latest version of DevKit is released.\n\n'
