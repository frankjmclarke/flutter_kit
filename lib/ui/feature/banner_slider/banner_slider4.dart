...
class _BannerSlider4PageState extends State<BannerSlider4Page> {
  ...
  @override
  void initState() {
    bannerData.add(BannerSliderModel(id: 1, image: GLOBAL_URL+'/home_banner/1.jpg'));
    bannerData.add(BannerSliderModel(id: 2, image: GLOBAL_URL+'/home_banner/2.jpg'));
    bannerData.add(BannerSliderModel(id: 3, image: GLOBAL_URL+'/home_banner/3.jpg'));
    bannerData.add(BannerSliderModel(id: 3, image: GLOBAL_URL+'/home_banner/4.jpg'));
    bannerData.add(BannerSliderModel(id: 3, image: GLOBAL_URL+'/home_banner/5.jpg'));
    super.initState();
  }
