    ...
    return Scaffold(
        ...
        body: ListView(
          ...
          children: [
            ...
            SizedBox(height: 18),
            _globalWidget.screenDetailList(context: context, title: 'Backdrop 1 - Default Backdrop', page: Backdrop1Page()),
            _globalWidget.screenDetailList(context: context, title: 'Backdrop 2 - Customize Backdrop', page: Backdrop2Page()),
            _globalWidget.screenDetailList(context: context, title: 'Backdrop 3 - Backdrop With Navigation', page: Backdrop3Page()),
          ],
        )
    );
  }
