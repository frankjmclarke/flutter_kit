...
class _Home3PageState extends State<Home3Page> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _bannerData.add(BannerSliderModel(id: 5, image: GLOBAL_URL+'/home_banner/5.jpg'));
    _bannerData.add(BannerSliderModel(id: 4, image: GLOBAL_URL+'/home_banner/4.jpg'));
    _bannerData.add(BannerSliderModel(id: 1, image: GLOBAL_URL+'/home_banner/1.jpg'));
    _bannerData.add(BannerSliderModel(id: 2, image: GLOBAL_URL+'/home_banner/2.jpg'));
    _bannerData.add(BannerSliderModel(id: 3, image: GLOBAL_URL+'/home_banner/3.jpg'));

    _categoryData.add(CategoryModel(id: 1, name: 'Fashion', image: GLOBAL_URL+'/category/fashion.png'));
    _categoryData.add(CategoryModel(id: 2, name: 'Smartphone & Tablets', image: GLOBAL_URL+'/category/smartphone.png'));
    _categoryData.add(CategoryModel(id: 3, name: 'Electronic', image: GLOBAL_URL+'/category/electronic.png'));
    _categoryData.add(CategoryModel(id: 4, name: 'Otomotif', image: GLOBAL_URL+'/category/otomotif.png'));
    _categoryData.add(CategoryModel(id: 5, name: 'Sport', image: GLOBAL_URL+'/category/sport.png'));
    _categoryData.add(CategoryModel(id: 6, name: 'Food', image: GLOBAL_URL+'/category/food.png'));
    _categoryData.add(CategoryModel(id: 7, name: 'Voucher\nGame', image: GLOBAL_URL+'/category/voucher_game.png'));
    _categoryData.add(CategoryModel(id: 8, name: 'Health & Care', image: GLOBAL_URL+'/category/health.png'));
    _categoryData.add(CategoryModel(id: 9, name: 'Food', image: GLOBAL_URL+'/category/food.png'));
    _categoryData.add(CategoryModel(id: 10, name: 'Electronic', image: GLOBAL_URL+'/category/electronic.png'));
    _categoryData.add(CategoryModel(id: 11, name: 'Fashion', image: GLOBAL_URL+'/category/fashion.png'));
    _categoryData.add(CategoryModel(id: 12, name: 'Sport', image: GLOBAL_URL+'/category/sport.png'));
    _categoryData.add(CategoryModel(id: 13, name: 'Voucher\nGame', image: GLOBAL_URL+'/category/voucher_game.png'));
    _categoryData.add(CategoryModel(id: 14, name: 'Smartphone & Tablets', image: GLOBAL_URL+'/category/smartphone.png'));
    _categoryData.add(CategoryModel(id: 15, name: 'Health & Care', image: GLOBAL_URL+'/category/health.png'));
    _categoryData.add(CategoryModel(id: 16, name: 'Otomotif', image: GLOBAL_URL+'/category/otomotif.png'));
