...
class _Home1PageState extends State<Home1Page> {
  ...
  void initState() {
    ...
    _categoryData.add(CategoryModel(id: 1, name: 'Outlet Store', image: GLOBAL_URL+'/menu/store.png'));
    _categoryData.add(CategoryModel(id: 2, name: 'Product', image: GLOBAL_URL+'/menu/products.png'));
    _categoryData.add(CategoryModel(id: 3, name: 'Buy Online', image: GLOBAL_URL+'/menu/buy_online.png'));
    _categoryData.add(CategoryModel(id: 4, name: 'Apply for Credit', image: GLOBAL_URL+'/menu/apply_credit.png'));
    _categoryData.add(CategoryModel(id: 5, name: 'Credit\nApplication\nStatus', image: GLOBAL_URL+'/menu/credit_application_status.png'));
    _categoryData.add(CategoryModel(id: 6, name: 'Credit Payment', image: GLOBAL_URL+'/menu/credit_payment.png'));
    _categoryData.add(CategoryModel(id: 7, name: 'Commission', image: GLOBAL_URL+'/menu/commission.png'));
    _categoryData.add(CategoryModel(id: 8, name: 'Check Point', image: GLOBAL_URL+'/menu/point.png'));
    _categoryData.add(CategoryModel(id: 9, name: 'Contact Us', image: GLOBAL_URL+'/menu/contact_us.png'));
