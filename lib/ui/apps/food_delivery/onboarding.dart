...
class _OnBoardingPageState extends State<OnBoardingPage> {
  final pages = [
    SkOnboardingModel(
        ...
        imageFromUrl: GLOBAL_URL+'/apps/food_delivery/onboarding/choose.png'),
    SkOnboardingModel(
        title: 'Delivery',
        description: 'Choose the delivery and then pay the food',
        titleColor: Colors.black,
        descripColor: Color(0xFF929794),
        imageFromUrl: GLOBAL_URL+'/apps/food_delivery/onboarding/delivery.png'),
    SkOnboardingModel(
        title: 'Food Arrived',
        description: 'Wait until the food comes to your place',
        titleColor: Colors.black,
        descripColor: Color(0xFF929794),
        imageFromUrl: GLOBAL_URL+'/apps/food_delivery/onboarding/arrived.png'),
    SkOnboardingModel(
        title: 'Enjoy',
        description: 'Enjoy your food at home',
        titleColor: Colors.black,
        descripColor: Color(0xFF929794),
        imageFromUrl: GLOBAL_URL+'/apps/food_delivery/onboarding/enjoy.png'),
  ];
