...
class _NavPage1State extends State<NavPage1> {
  ...
  void initState() {
    ...
    _movieData.add(BannerSliderModel(id: 1, name: 'Bloodshot', image: GLOBAL_URL+'/movie/bloodshot.jpg'));
    _movieData.add(BannerSliderModel(id: 2, name: 'Dolittle', image: GLOBAL_URL+'/movie/dolittle.jpg'));
    _movieData.add(BannerSliderModel(id: 3, name: 'The Invisible Man', image: GLOBAL_URL+'/movie/invisible_man.jpg'));
    _movieData.add(BannerSliderModel(id: 4, name: 'Peninsula', image: GLOBAL_URL+'/movie/peninsula.jpg'));
    _movieData.add(BannerSliderModel(id: 5, name: 'Train to Busan', image: GLOBAL_URL+'/movie/train_to_busan.jpg'));
    _movieData.add(BannerSliderModel(id: 6, name: 'Venom', image: GLOBAL_URL+'/movie/venom.jpg'));
    _movieData.add(BannerSliderModel(id: 7, name: '#Alive', image: GLOBAL_URL+'/movie/alive.jpg'));
    _movieData.add(BannerSliderModel(id: 8, name: 'Avengers: Endgame', image: GLOBAL_URL+'/movie/avenger.jpg'));
